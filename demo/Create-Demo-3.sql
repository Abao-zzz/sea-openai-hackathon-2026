USE master;
GO
IF DB_ID(N'AlyvoStage5Demo3') IS NOT NULL THROW 51000, 'Demo database already exists; no changes made.', 1;
CREATE DATABASE [AlyvoStage5Demo3] COLLATE Latin1_General_100_CS_AS;
GO
ALTER DATABASE [AlyvoStage5Demo3] SET COMPATIBILITY_LEVEL=170;
ALTER DATABASE [AlyvoStage5Demo3] SET QUERY_STORE=ON (OPERATION_MODE=READ_WRITE,QUERY_CAPTURE_MODE=ALL);
GO
USE [AlyvoStage5Demo3];
GO
