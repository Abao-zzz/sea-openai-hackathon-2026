...
BEGIN TRANSACTION;
IF OBJECT_ID(N'dbo.Demo02_DailySalesReport') IS NOT NULL
    THROW 51000, 'New demo name already exists; no changes made.', 1;
...
DROP PROCEDURE IF EXISTS [dbo].[Demo01_RewriteDailyOrders];
...
BEGIN
    ...
    ORDER BY OrderDate;
END;');
EXEC(N'CREATE PROCEDURE [dbo].[Demo02_DailySalesReport]
AS
BEGIN
    SET NOCOUNT ON;
