...
GO
ALTER DATABASE [AlyvoStage5Demo1] SET COMPATIBILITY_LEVEL=170;
ALTER DATABASE [AlyvoStage5Demo1] SET QUERY_STORE=ON (OPERATION_MODE=READ_WRITE,QUERY_CAPTURE_MODE=ALL);
GO
USE [AlyvoStage5Demo1];
GO
